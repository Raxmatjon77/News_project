...
from .views import user_login, dashboard_view, user_register, SignupView, edit_user, EditUserView, ProfileView
from django.contrib.auth.views import LoginView,LogoutView,PasswordChangeDoneView, \
PasswordChangeView,PasswordResetConfirmView,PasswordResetView,PasswordResetDoneView, \
